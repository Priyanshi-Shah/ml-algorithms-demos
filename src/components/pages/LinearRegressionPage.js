// src/components/pages/LinearRegressionPage.js
import React, { useState } from 'react';
import { Link } from 'react-router-dom';
import SimpleLinearRegression from '../algorithms/LinearRegression/SimpleLinearRegression';
  ...
  const regressionTypes = [
    {
      ...
      description: 'Classic y = mx + b relationship between two variables',
      difficulty: 'Beginner',
      status: 'ready'
    },
    {
      ...
      description: 'Multiple input variables predicting one output',
    ...
    },
    {
      ...
      description: 'Fitting curved lines to capture non-linear relationships',
      difficulty: 'Intermediate', 
      status: 'coming-soon'
    },
    {
      ...
      description: 'Regularized regression to prevent overfitting',
      difficulty: 'Advanced',
      status: 'coming-soon'
    }
  ];
    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center space-x-4 mb-6">
          ...
          <div>
            <h1 className="text-4xl font-bold text-gray-900">Linear Regression</h1>
            <p className="text-gray-600">Explore different types of linear regression algorithms</p>
          </div>
        </div>
      </div>
        ...
        {activeComponent.status === 'ready' ? (
          ...
          <div className="p-16 text-center">
            ...
            <p className="text-gray-500 text-sm mt-2">
              For now, try the Simple Linear Regression demo above.
            </p>
          </div>
        )}
      </div>
